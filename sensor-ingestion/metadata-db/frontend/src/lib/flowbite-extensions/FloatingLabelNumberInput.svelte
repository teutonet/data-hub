<script lang="ts">
	/// Adapted from https://github.com/themesberg/flowbite-svelte/blob/main/src/lib/forms/NumberInput.svelte
	/// and https://github.com/themesberg/flowbite-svelte/blob/main/src/lib/forms/FloatingLabelInput.svelte
	/// to force the type of the input to be `number`. Flowbite-Svelte did not, at the time of writing this comment,
