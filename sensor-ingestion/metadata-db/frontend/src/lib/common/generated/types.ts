...
export type Mutation = {
  ...
  sensorMassCopy?: Maybe<SensorMassCopyPayload>;
...
/** The root mutation type which contains root level fields which mutate data. */
export type MutationSensorMassCopyArgs = {
...
export type SensorMassCopyInput = {
   ...
   */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  findSensortype?: InputMaybe<Scalars['Boolean']['input']>;
  overwriteValues?: InputMaybe<Scalars['Boolean']['input']>;
  targetProjectId?: InputMaybe<Scalars['String']['input']>;
  thingIds?: InputMaybe<Array<InputMaybe<Scalars['UUID']['input']>>>;
};

/** The output of our `sensorMassCopy` mutation. */
export type SensorMassCopyPayload = {
  /**
   * The exact same `clientMutationId` that was provided in the mutation input,
   * unchanged and unused. May be used by a client to track mutations.
   */
...
export type Thing = Node & {
  ...
  errorTimestamp?: Maybe<Scalars['Datetime']['output']>;
  ...
  latestError?: Maybe<Scalars['String']['output']>;
...
export type ThingCondition = {
  ...
  errorTimestamp?: InputMaybe<Scalars['Datetime']['input']>;
  ...
  latestError?: InputMaybe<Scalars['String']['input']>;
...
export enum ThingsOrderBy {
  ...
  ErrorTimestampAsc = 'ERROR_TIMESTAMP_ASC',
  ErrorTimestampDesc = 'ERROR_TIMESTAMP_DESC',
  GeohashAsc = 'GEOHASH_ASC',
  GeohashDesc = 'GEOHASH_DESC',
  HasErrorAsc = 'HAS_ERROR_ASC',
  HasErrorDesc = 'HAS_ERROR_DESC',
  IdAsc = 'ID_ASC',
  IdDesc = 'ID_DESC',
  InstallAsc = 'INSTALL_ASC',
  InstallDesc = 'INSTALL_DESC',
  LatestErrorAsc = 'LATEST_ERROR_ASC',
  LatestErrorDesc = 'LATEST_ERROR_DESC',
  LatAsc = 'LAT_ASC',
  LatDesc = 'LAT_DESC',
...
export type GetThingByIdQuery = { thing?: { id: string, name: string, project: string, status?: string | null, lat?: any | null, locationdesc?: string | null, locationname?: string | null, long?: any | null, nodeId: string, install?: boolean | null, ownedby?: string | null, public?: boolean | null, altitude?: any | null, appid?: string | null, deveui?: string | null, devid?: string | null, geohash?: string | null, sensorId?: string | null, customLabels?: Array<string | null> | null, latestError?: string | null, errorTimestamp?: string | null, sensor?: { name: string, id: string, nodeId: string, datasheet?: string | null, appeui?: string | null } | null, thingLivedatum?: { payload?: string | null } | null } | null };
...
export type ThingFragment = { id: string, name: string, project: string, status?: string | null, locationname?: string | null, locationdesc?: string | null, lat?: any | null, long?: any | null, altitude?: any | null, nodeId: string, ownedby?: string | null, public?: boolean | null, appid?: string | null, deveui?: string | null, devid?: string | null, geohash?: string | null, customLabels?: Array<string | null> | null, latestError?: string | null, errorTimestamp?: string | null, sensor?: { name: string, id: string, project: string, nodeId: string, datasheet?: string | null, appeui?: string | null } | null, thingLivedatum?: { payload?: string | null } | null };
